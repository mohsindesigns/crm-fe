              ...
              <Table className="w-full min-w-160">
                <TableHeader>
                  <TableRow className="border-b border-gray-200 bg-gray-100">
                    ...
                    <TableHead className="text-left text-xs font-semibold text-gray-500 uppercase tracking-wider px-5 py-3.5">Assigned</TableHead>
                ...
                <TableBody className="divide-y divide-gray-50">
                  {leadsLoading ? (
                    <TableRow><TableCell colSpan={6} className="px-5 py-12 text-center text-sm text-gray-400">Loading…</TableCell></TableRow>
                  ) : (leads as any[]).length === 0 ? (
                    <TableRow><TableCell colSpan={6} className="px-5 py-12 text-center text-sm text-gray-400">No leads yet.</TableCell></TableRow>
                  ) : (
                    (leads as any[]).map((lead) => (
                      ...
                      >
                        ...
                        <TableCell className="px-5 py-3.5 text-sm text-gray-600">{lead.project?.name || '—'}</TableCell>
